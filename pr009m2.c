...
int main() {
	...
	size_t size;
	char resstring1[86], resstring2[94]; //resstring1 - строка, полученная ребенком
	...
	size = write(fd2[1], "Информация для родительского процесса от родителя", 94);
		if(size !=94) {
